...
def set_hight_light_color(color):
    if color == "green":
      return [y, red_default, yellow, green_default, 350, next_color[color]]
    elif color == "yellow":
      return [z, red, yellow_default, green_default, 130, next_color[color]]
   
    return [x, red_default, yellow_default, green, 570, next_color[color]]
